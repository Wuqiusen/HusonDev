...
import com.example.mylibrary.widget.MyDialog;
        ...
        try {
           ...
           /* URL建立连接 */
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {//判断SD卡是否挂载
                File foder = new File(Environment.getExternalStorageDirectory(), AppUtil.getAppName(mActivity)+"download" + "/");
                File file = new File(foder, AppUtil.getAppName(mActivity));
                if (!foder.exists()) {
                    foder.mkdirs();
                }
